 class Journal:
    ...
    def get_letter_grades(self, student_name):  # student_name to *args and add throw_exception
    ...
    def get_student_average(self, student_name):   # student_name to *args and add throw_exception
        for dict in self.student_data:
            if student_name in dict["name"]:
    ...
    # should accept student_name, should have throw_exception named argument and **kwargs
    # and should update self.student_data.
